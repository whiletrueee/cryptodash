    ...
    <div className="hidden sm:flex flex-row justify-between py-5 px-5 bg-[#F4F4FA] items-center">
      ...
      <div className="px-2 flex justify-between items-center">
        ...
        <div className="buttons flex-row justify-around items-centers">
         <Link to="/login" className="mr-2"><CButton label="Login" textsize="md" py="1" /></Link>
         <Link to="/signup"><CButton label="Signup" textsize="md" py="1" /></Link>
         <Link to="/" className="ml-2"><CButton label="Home" textsize="md" py="1" /></Link>
        </div>
      </div>
    </div>
  );
